...
class UserSettingsManager {
    ...
    private var executablePathString: String {
        didSet {
            UserDefaultsKey.executablePath.setValue(
                value: self.executablePathString
            )
        }
    }
    ...
    var executablePathUrl: URL {
        get {
            ...
            return URL(string: fileURL.absolutePath) ?? URL(
                string: self.executablePathString
            )!
        }
        set(newValue) {
    ...
    var executableExists: Bool {
        return FileManager.default.isExecutableFile(
            atPath: self.executablePathString
        )
    }
    ...
    var startSystemTimeoutSeconds: Int32 = 10 {
        didSet {
            UserDefaultsKey.startSystemTimeoutSeconds.setValue(
                value: self.startSystemTimeoutSeconds
            )
        }
    }
    ...
    var stopContainerTimeoutSeconds: Int32 = 5 {
        didSet {
            UserDefaultsKey.stopContainerTimeoutSeconds.setValue(
                value: self.stopContainerTimeoutSeconds
            )
        }
    }
    ...
    var shutdownSystemTimeoutSeconds: Int32 = 20 {
        didSet {
            UserDefaultsKey.shutdownSystemTimeoutSeconds.setValue(
                value: self.shutdownSystemTimeoutSeconds
            )
        }
    }
    ...
    init() {
        self.executablePathString =
            UserDefaultsKey.executablePath.getValue() as? String
            ?? Self.defaultExecutablePathString
        self.appRootPathString =
            UserDefaultsKey.appRootPath.getValue() as? String
            ?? Self.defaultAppRootUrl.absolutePath
        self.startSystemTimeoutSeconds =
            UserDefaultsKey.appRootPath.getValue() as? Int32
            ?? Self.defaultStartSystemTimeoutSeconds
        self.stopContainerTimeoutSeconds =
            UserDefaultsKey.appRootPath.getValue() as? Int32
            ?? Self.defaultStopContainerTimeoutSeconds
        self.shutdownSystemTimeoutSeconds =
            UserDefaultsKey.appRootPath.getValue() as? Int32
            ?? Self.defaultShutdownSystemTimeoutSeconds
    }
