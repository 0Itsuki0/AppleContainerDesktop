...
struct ContainerListView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 24) {
            ...
            HStack(spacing: 36) {
                ...
                if !selections.isEmpty {
                    let selectedContainers = self.containers.filter({
                    ...
                    HStack {
                        ...
                        if selectedContainers.allSatisfy({
                            $0.container.status == .running
                        }) {
                            Button(
                                action: {
                                    Task {
            ...
            Table(
                ...
                columns: {
                    ...
                    TableColumn(TableHelper.columnHeader("Image")) {
                        container in
                    ...
                    if !self.applicationManager.isSystemRunning {
                        ...
                        ContentUnavailableView(
                            self.trimmedText.isEmpty
                                && !self.runningContainerOnly
                                ? "No Containers Found"
                                : "No Matching Containers",
                            systemImage: DisplayCategory.container.icon
                        )
                    }
                }
            )
        ...
        .onChange(
            of: self.applicationManager.refreshContainerNeeded,
            initial: true,
            {
